...
namespace US_Land_System_Alpha
{
    public partial class Remarks : Form
    {
        ...
        private void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            string sqlQuery = "INSERT INTO Remarks (Remark_ID, Description, Type, Remark, Active) VALUES (" + "'" + RemarkID_Value.Text + "'" + "," + "'" + Description_Value + "'" + "," + "'" + Type_Value + "'" + "," + "'" + Remark_Value + "'" + "," + "'" + Active_Value + "'" + ")";
