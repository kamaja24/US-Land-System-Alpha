...
namespace US_Land_System_Alpha
{
    public partial class Codes : Form
    {
        ...
        private void SaveButton_Click(object sender, EventArgs e)
        {
            ...
            string sqlQuery = "INSERT INTO Codes (Code_Type, Code_ID, Description, Active, GL_Chart) VALUES (" + "'" + CodeType_Value.Text + "'" + "," + "'" + CodeID_Value + "'" + "," + "'" + Description_Value + "'" + "," + "'" + Active_Value + "'" + "," + "'" + GLChart_Value + "'" + ")";
